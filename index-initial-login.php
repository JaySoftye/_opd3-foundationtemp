...
<div class="modal fade" id="initial-login" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">

  <div class="modal-content">
    <div class="modal-body">
      <section class="container padding">
        <h2>Welcome to the New <strong>Online Professional Development</strong> Platform</h2>
