    ...
    <section class="container padding-bottom">
      ...
      <div class="row row-eq-height padding-top">
        ...
        <div class="col-lg-8">
          ...
          <h5><strong>Watch the full video</strong> to receive your certificate of completion upon passing of the course quiz.</h5>
          <p class="line-height-small"><strong>Chapters</strong><br /><small>Once you have viewed the entire video you will be able to navigate through the chapters below for quick reference points.</small></p>
          <div class="row course-chapters">

<div class="col-1 completed">
  <a href="http://opd-dev.teq.com/events/view/29/13843#" class="chapter-link" title="" data-chapteridx="0" data-start="0" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="00min 15secs" data-original-title="Chapter 1"></a>
</div>
<div class="col-1 completed">
...
<div class="col-1 completed">
  <a href="http://opd-dev.teq.com/events/view/29/13843#" class="chapter-link active" title="" data-chapteridx="4" data-start="50" data-toggle="popover" data-placement="bottom" data-trigger="hover" data-content="00min 10secs" data-original-title="Chapter 14"></a>
        ...
        <div class="col-lg-4 course-details">
          <ul class="nav">
            <li class="nav-item">
              <span class="course-details-date">9am - 10am EST, June 08, 2017</span>
            </li>
            <li class="nav-item category-duration-details">
              <span>8hr 54min</span>
            </li>
            <li class="nav-item">
              <?php include 'category-details-admin-menu-updated.php'; ?>
            </li>
          </ul>
          <article>
            <h6>iPhoto - Chapter 7</h6>
          ...
          <div class="row log-in-access active padding-bottom">
            ...
            <div class="col-lg-4 course-details badges">
    ...
    <?php include 'course-details-resources-updated.php'; ?>
