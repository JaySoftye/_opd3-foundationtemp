      ...
      <div id="getting-started-category-videos">
        ...
        <div id="getting-started-category-videos-1" class="getting-started-category-videos-container active">
          <div class="row row-eq-height padding-top padding-bottom">
            <div class="col-lg-8">
              <div class="pagePlayer" id="player">
                <video>
          ...
          <div class="row row-eq-height padding-top padding-bottom category-events">
            <article class="col-md-4">
              <div class="card" data-id="1"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">37min</span></li>
                ...
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3video.lwcdn.com/i/v-i-970221bd-eb7b-4a87-8626-1d7e1f8eda8a-4124x70.jpg"><source type="video/mp4" src="https://l3video.lwcdn.com/v-970221bd-eb7b-4a87-8626-1d7e1f8eda8a.mp4"></video>
                  </div>
                  <h5 class="card-title">SMART BOARD BASICS: 6000 SERIES</h5>
            ...
            <article class="col-md-4">
              <div class="card" data-id="15"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">26min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3video.lwcdn.com/i/v-i-36145672-41e5-4a48-b6a0-16b2c0da94d1-1124x70.jpg"><source type="video/mp4" src="https://l3video.lwcdn.com/v-36145672-41e5-4a48-b6a0-16b2c0da94d1.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="4"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">02min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3video.lwcdn.com/i/v-i-cf9963e2-f532-4ef8-8e58-3a9fc90f34d3-1124x70.jpg"><source type="video/mp4" src="https://l3video.lwcdn.com/v-cf9963e2-f532-4ef8-8e58-3a9fc90f34d3.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="5"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">03min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3video.lwcdn.com/i/v-i-7997c19a-de6b-4efc-a4e1-99fde6ef17fd-4124x70.jpg"><source type="video/mp4" src="https://l3video.lwcdn.com/v-7997c19a-de6b-4efc-a4e1-99fde6ef17fd.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="16"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">38min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3video.lwcdn.com/i/v-i-87574164-da3e-4f9d-b3cf-aed53bbc86b0-4124x70.jpg"><source type="video/mp4" src="https://l3video.lwcdn.com/v-87574164-da3e-4f9d-b3cf-aed53bbc86b0.mp4"></video>
                  </div>
        ...
        <div id="getting-started-category-videos-4" class="getting-started-category-videos-container hidden">
          <div class="row row-eq-height padding-top padding-bottom">
            ...
            <div class="col-lg-4 course-details">
              <ul class="nav">
                <li class="nav-item category-duration-details">
                  <span id="playerTime">42min</span>
                </li>
                <li class="nav-item"></li>
              </ul>
              <article>
                <h5 id="playerTitle">What's New in SMART Learning Suite 16.2</h5>
          ...
          <div class="row row-eq-height padding-top padding-bottom category-events">
            <article class="col-md-4">
              <div class="card" data-id="10"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">42min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-66a4b52f-33d9-4d24-989a-6e4e5abdaec1-1124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-66a4b52f-33d9-4d24-989a-6e4e5abdaec1.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="9"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">29min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-888e3d05-4157-4e49-add4-bf5c4d9cabec-3124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-888e3d05-4157-4e49-add4-bf5c4d9cabec.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="11"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time"47min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-f40ab5b0-19b9-454f-a550-5ce246a7a56f-1124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-f40ab5b0-19b9-454f-a550-5ce246a7a56f.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="12"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">45min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-ccc07e12-b2cd-4658-8cf8-d9f0dcb21646-5124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-ccc07e12-b2cd-4658-8cf8-d9f0dcb21646.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="13"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">40min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-3718ab28-35ac-41cc-bab3-abb6eb4c55ec-1124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-3718ab28-35ac-41cc-bab3-abb6eb4c55ec.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="14"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time"35min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-97bfedd5-9274-45ec-895b-b996d12f2f87-5124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-97bfedd5-9274-45ec-895b-b996d12f2f87.mp4"></video>
                  </div>
        ...
        <div id="getting-started-category-videos-2" class="getting-started-category-videos-container hidden">
          <div class="row row-eq-height padding-top padding-bottom">
            ...
            <div class="col-lg-4 course-details">
              <ul class="nav">
                <li class="nav-item category-duration-details">
                  <span id="playerTime">45min</span>
                </li>
                <li class="nav-item"></li>
              </ul>
              <article>
                <h5 id="playerTitle">Preparing Your Google Drive for a New School Year</h5>
          ...
          <div class="row row-eq-height padding-top padding-bottom category-events">
            <article class="col-md-4">
              <div class="card" data-id="7"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">45min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                ...
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-ecd8a946-ebc7-4d57-bbab-d3326ca3df19-3124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-ecd8a946-ebc7-4d57-bbab-d3326ca3df19.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="2"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">05min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3video.lwcdn.com/i/v-i-90dc2974-d56d-4b39-843b-9f5241836ed7-1124x70.jpg"><source type="video/mp4" src="https://l3video.lwcdn.com/v-90dc2974-d56d-4b39-843b-9f5241836ed7.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="8"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">39min</span></li>
                    <li class="nav-item category-sessions-details"></li><li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-2a2c7f5d-3659-4e18-90c0-0b47eaef914f-1124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-2a2c7f5d-3659-4e18-90c0-0b47eaef914f.mp4"></video>
                  </div>
        ...
        <div id="getting-started-category-videos-3" class="getting-started-category-videos-container hidden">
          <div class="row row-eq-height padding-top padding-bottom">
            ...
            <div class="col-lg-4 course-details">
              <ul class="nav">
                <li class="nav-item category-duration-details">
                  <span id="playerTime">26min</span>
                </li>
                <li class="nav-item"></li>
              </ul>
              <article>
                <h5 id="playerTitle">Labdisc: Heart Rate</h5>
          ...
          <div class="row row-eq-height padding-top padding-bottom category-events">
            <article class="col-md-4">
              <div class="card" data-id="6"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">26min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                ...
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-1e6c742b-4ec1-41c1-b784-0cd74f7869c2-1124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-1e6c742b-4ec1-41c1-b784-0cd74f7869c2.mp4"></video>
                  </div>
        ...
        <div id="getting-started-category-videos-5" class="getting-started-category-videos-container hidden">
          <div class="row row-eq-height padding-top padding-bottom">
            ...
            <div class="col-lg-4 course-details">
              ...
              <article>
                <h5 id="playerTitle">Ultimaker: Optimizing Your 3D Print</h5>
                <p id="playerDesc">The Cura 2.4 Software by Ultimaker has over 200 settings to adjust your 3D print to fit your needs. Join us as we show you where to download the software and some specific details of how to optimize your 3D print like print setup, materials, and scaling.</p>
              </article>
              <div class="row log-in-access active padding-bottom">
                <div class="col-lg-8 course-details">
                  <a class="btn quiz-btn active" data-toggle="modal" data-target=".course-quiz"><img src="assets/take-quiz-icon.svg" width="179" height="36" alt="Take Certificationi Quiz" /></a>
          ...
          <div class="row row-eq-height padding-top padding-bottom category-events">
            <article class="col-md-4">
              <div class="card" data-id="17"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">45min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                ...
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-a9a52adb-c652-4cdf-adcc-7fe5bd189e40-1124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-a9a52adb-c652-4cdf-adcc-7fe5bd189e40.mp4"></video>
                  </div>
        ...
        <div id="getting-started-category-videos-6" class="getting-started-category-videos-container hidden">
          <div class="row row-eq-height padding-top padding-bottom">
            ...
            <div class="col-lg-4 course-details">
              <ul class="nav">
                <li class="nav-item category-duration-details">
                  <span id="playerTime">10min</span>
                </li>
                <li class="nav-item"></li>
              </ul>
              <article>
                <h5 id="playerTitle">New York State CTLE Requirements</h5>
          ...
          <div class="row row-eq-height padding-top padding-bottom category-events">
            <article class="col-md-4">
              <div class="card" data-id="18"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">10min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-a4c40690-16d6-467c-966c-f79daaaae9cc-5124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-a4c40690-16d6-467c-966c-f79daaaae9cc.mp4"></video>
                  </div>
            ...
            <article class="col-md-4">
              <div class="card" data-id="19"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">41min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                    <li class="nav-item"></li>
                  </ul>
                </div>
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-661b1cfe-310b-4d75-8775-3df98545a405-1124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-661b1cfe-310b-4d75-8775-3df98545a405.mp4"></video>
                  </div>
        ...
        <div id="getting-started-category-videos-7" class="getting-started-category-videos-container hidden">
          <div class="row row-eq-height padding-top padding-bottom">
            ...
            <div class="col-lg-4 course-details">
              <ul class="nav">
                <li class="nav-item category-duration-details">
                  <span id="playerTime">03min</span>
                </li>
                <li class="nav-item"></li>
              </ul>
              <article>
                <h5 id="playerTitle">Getting Started with your Audio Enhancement</h5>
                <p id="playerDesc">In our Introduction to Audio Enhancement video, we will take you through the basics and proper use and care of your teacher and student microphones. Join us to learn about charging, pairing and tips for using the Audio Enhancement system.</p>
              </article>
              <div class="row log-in-access active padding-bottom">
                <div class="col-lg-8 course-details">
                  <a class="btn quiz-btn active" data-toggle="modal" data-target=".course-quiz"><img src="assets/take-quiz-icon.svg" width="179" height="36" alt="Take Certificationi Quiz" /></a>
          ...
          <div class="row row-eq-height padding-top padding-bottom category-events">
            <article class="col-md-4">
              <div class="card" data-id="20"><div class="video-thumb">
                <div class="card-header">
                  <ul class="nav">
                    <li class="nav-item category-duration-details"><span class="card-time">03min</span></li>
                    <li class="nav-item category-sessions-details"></li>
                ...
                <div class="card-body">
                  <div class="videoPlayer">
                    <video poster="http://l3561eb26.lwcdn.com/i/v-i-042358fd-6703-40ad-bacf-a64ff94328ac-2124x70.jpg"><source type="video/mp4" src="https://l3561eb26.lwcdn.com/v-042358fd-6703-40ad-bacf-a64ff94328ac.mp4"></video>
                  </div>
        ...
        <script>
          $(function () {
            $('div.pagePlayer').flowplayer();
          });

          $("div.video-thumb").click(function(){
            var videoContent = $(this).clone();
            $("div#player").replaceWith( $(videoContent).find('div.videoPlayer').attr('id', 'player') );
            $("h5#playerTitle").replaceWith( $(videoContent).find('h5.card-title').attr('id', 'playerTitle') );
            $("p#playerDesc").replaceWith( $(videoContent).find('p.card-text').attr('id', 'playerDesc') );
            $("span#playerTime").replaceWith( $(videoContent).find('span.card-time').attr('id', 'playerTime') );
              $('div#player').flowplayer();
                $('html, body').animate({ scrollTop: $('#getting-started-categories').offset().top }, 400);
          });
        </script>
