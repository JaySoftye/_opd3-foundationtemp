...
<section class="container padding-bottom">
  ...
  <div class="row padding-top">
    <div class="col">
      ...
      <p>Here you have access to view all the How-to Videos on how to navigate our website.</p>
    </div>
  </div>
  ...
  <div class="row padding-top">
    ...
    <article class="col-md-4">
      <div class="card">
        <div class="card-header">
          <ul class="nav">
            <li class="nav-item category-sessions-details"><span><strong>Add to Playlist</strong></span></li>
    ...
    <article class="col-md-4">
      <div class="card">
        <div class="card-header">
          <ul class="nav">
            <li class="nav-item category-sessions-details"><span><strong>Chapters Screen</strong></span></li>
            <li class="nav-item"></li>
          </ul>
        </div>
    ...
    <article class="col-md-4">
      <div class="card">
        <div class="card-header">
          <ul class="nav">
            <li class="nav-item category-sessions-details"><span><strong>Group Code</strong></span></li>
            <li class="nav-item"></li>
          </ul>
        </div>
    ...
    <article class="col-md-4">
      <div class="card">
        <div class="card-header">
          <ul class="nav">
            <li class="nav-item category-sessions-details"><span><strong>Quiz</strong></span></li>
            <li class="nav-item"></li>
          </ul>
        </div>
    ...
    <article class="col-md-4">
      <div class="card">
        <div class="card-header">
          <ul class="nav">
            <li class="nav-item category-sessions-details"><span><strong>Register for a Course</strong></span></li>
            <li class="nav-item"></li>
          </ul>
        </div>
    ...
    <article class="col-md-4">
      <div class="card">
        <div class="card-header">
          <ul class="nav">
            <li class="nav-item category-sessions-details"><span><strong>User Profile</strong></span></li>
            <li class="nav-item"></li>
          </ul>
        </div>
