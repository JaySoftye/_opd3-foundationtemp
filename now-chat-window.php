<div id="now-instructional-support">
  <div class="row">
    <div class="col-4">
      <img src="assets/now-instructional-support-chat-window.svg" alt="nOw Instructional Support" />
    </div>
  </div>
</div>
...
<aside id="now-chat-window">
  ...
  <div class="row">
    <div class="col-4">
      <img src="assets/now-instructional-support-chat-via.svg" alt="Chat nOw or connect via one of our other options" />
    </div>
    <div class="col">
