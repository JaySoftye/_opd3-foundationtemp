<div id="now-instructional-support">
  <div class="row">
    <div class="col-4">
      <a href="javascript:void(0);" onclick="olark('api.box.expand')"><img src="assets/now-instructional-support-chat-window.svg" alt="nOw Instructional Support" /></a>
    </div>
  </div>
</div>
...
<aside id="now-chat-window">
  ...
  <div class="row" id="now-chat-box">
    <div class="col">
      <div id="olark-box-container" style="overflow: auto;"></div>
      <!-- begin olark code -->
      ...
      olark.identify('2098-857-10-1001');</script>
      <!-- end olark code -->
    </div>
  </div>
</aside>
